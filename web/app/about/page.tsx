    ...
    <div data-theme="dark" className={styles.root}>
      <article className={styles.article}>
        ...
        <section>
          ...
          <p>
            This is not an accusation against any single pharmacy, distributor, or county. Shipment
            volume is not proof of wrongdoing; correlation with overdose deaths is not causation.
            Read the <Link href="/methodology">methodology</Link> for caveats.
          </p>
        </section>
        ...
        <section>
          <h2>Contact</h2>
          <p>
            <a href="https://github.com/anomalyco/opencode">GitHub</a> — open an issue or send a PR.
            Press inquiries welcome via GitHub discussions.
          </p>
        </section>
      </article>
      <MethodologyFooter />
