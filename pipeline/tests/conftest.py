...
def agg_master_parquet(tmp_path_factory):
    ...
    pl.DataFrame({
        "distributor": ["McKesson", "Cardinal", "AmerisourceBergen",
                        "McKesson", "Cardinal", "AmerisourceBergen"],
        "year":        [2011, 2011, 2011, 2012, 2012, 2012],
        "pills":       [3_200_000.0, 1_800_000.0, 900_000.0,
                        4_500_000.0, 2_200_000.0, 1_300_000.0],
    ...
    pl.DataFrame({
        ...
        "notable_actions": [
            [{"title": "United States v. Cardinal Health", "url": "https://example.org/1", "target": None}],
